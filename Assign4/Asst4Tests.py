...
t2 = f1 != f2 and f1 == f3
t3 = equals("Flight: ABC123 from London to Athens {international}", f1.__repr__()) and equals(
    "Flight: BCS101 from Albuquerque to Omaha {domestic}", f2.__repr__())
...
acodes = ["JRA488", "MCK533", "QGC143", "KPP582", "CFE916", "MGG225", "WCL282", "LZI123", "DDJ597", "CUN974", "HLR281",
          "PJT823", "AOK874"]
total = 0
for a in acodes:
    if a in cfs:
...
acodes = ["EIH124", "XGY802", "YZF667", "UWL771", "ZBH196", "APE574", "QFK290", "FFC468", "MOO674", "PJT823", "PBV867",
          "ONY044", "EWQ950", "VNN918", "ISA009"]
total = 0
for a in acodes:
    if a in cfs:
        total += 1
